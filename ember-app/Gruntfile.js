module.exports = function(grunt) {
  ...
  grunt.registerTask('testem', "Run your apps's tests once. Uses Google Chrome by default.", [
  ...
  grunt.registerTask('testem:ci', "Run your app's tests in PhantomJS. For use in continuous integration (i.e. Travis CI).", [
                     'clean:debug', 'build:debug', 'testem:ci:basic' ]);
  ...
  grunt.registerTask('testem:browsers', "Run your app's tests in multiple browsers (see tasks/options/karma.js for configuration).", [
  ...
  grunt.registerTask('testem:server', "Start a Testem test server and the standard development server.", function(proxyMethod) {
    var expressServerTask = 'expressServer:debug';
    if (proxyMethod) {
      expressServerTask += ':' + proxyMethod;
    }
